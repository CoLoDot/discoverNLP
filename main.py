...
if __name__ == '__main__':
    ...
    if nlp.lang == 'fr':
        ...
        # nlp_matcher.process_pattern_on_input('Hello, I love to listen to Nina Simone !', [{'TEXT': 'Nina'},
        # {'TEXT': 'Simone'}])
        # nlp_matcher.match_lexical_attr('2018 FIFA World Cup: France won!')

        print(nlp.semantic_similarities_docs("Hello i am a cat", "Hello i am a dog"))
